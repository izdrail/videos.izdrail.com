    ...
    def search_videos(self, query: str, orientation: str = "portrait", 
        ...
        try:
            ...
            for hit in data.get('hits', []):
                ...
                best_video = videos.get('medium') or videos.get('small') or videos.get('large') or videos.get('tiny')
                ...
                if best_video:
                    results.append({
                        ...
                        'thumbnail': hit.get('userImageURL') # or hit.get('videos')['large']['thumbnail'] if exists
                    })
